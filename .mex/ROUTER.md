...
- MEX 0.8.1 scaffold initialized with Codex skills.
- Product brief, architecture proposal, data plan, asset plan and roadmap are documented in the vault.

**Not yet built:**
- Android app, route engine, map UI and Room persistence.
...
- Blender/GLB asset library, regional map package and real-device tests.

**Known issues:**
- Platform, first geography, species groups and corridor radius are still open decisions.
- Exact Android stack versions, offline map source and any Firebase sync boundary are still open decisions.
