...
Un'app personale che analizza una posizione o un itinerario e mostra specie animali documentate o plausibili nell'area, con fonti, schede informative e asset 3D.
...
- Non presentare un'osservazione storica come presenza certa o in tempo reale.
- Conservare sempre fonte, data, licenza e qualità del dato quando si normalizza un record.
- Non rendere obbligatorio un servizio a pagamento per usare o costruire il progetto.
- Non inviare una traccia completa a un provider esterno quando basta un'area aggregata.
- Non includere asset o credenziali senza licenza/provenienza verificabile.
